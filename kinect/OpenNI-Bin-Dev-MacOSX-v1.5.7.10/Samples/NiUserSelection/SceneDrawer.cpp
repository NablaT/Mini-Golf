...
void SceneDrawer::DrawSkeleton(XnUserID nUserId)
{
    ...
    for(XnUInt16 j=0; j<numLimbs; j++)
    {
        ...
        //  Pour tout le skelete
        //  glVertex2f(pLimbsPosArr[j*2].X, pLimbsPosArr[j*2].Y);
        //  glVertex2f(pLimbsPosArr[(j*2)+1].X, pLimbsPosArr[(j*2)+1].Y);



        glVertex2f(pLimbsPosArr[4].X, pLimbsPosArr[4].Y);
        glVertex2f(pLimbsPosArr[5].X , pLimbsPosArr[5].Y);


        glVertex2f(pLimbsPosArr[10].X, pLimbsPosArr[10].Y);
        glVertex2f(pLimbsPosArr[11].X , pLimbsPosArr[11].Y);


        int dir;
        int OLDDIRECTION;
        int XA = pLimbsPosArr[4].X;
        int XB = pLimbsPosArr[10].X;
        int YA = pLimbsPosArr[4].Y;
        int YB = pLimbsPosArr[10].Y;
        int DIRECTION = sqrt(pow(XB-XA,2)+pow(YB-YA,2));


        if(DIR != "DROIT"  &&  std::abs(YB-YA) < 5 && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            ...
            DIR = "DROIT";
            std::cout <<"DIRECTION  : DROIT" << std::endl;

            post(270);// dir = 0;

        }
        if(DIR != "-DROIT"  &&  std::abs(YB-YA) < 7 && OLDDIRECTION == DIRECTION && XB-XA < 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
        ...
        if(DIR != "DROITE 20" &&  YA < YB && std::abs(YB-YA) > 5 && std::abs(YB-YA) < 10  && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE 20";
            std::cout <<"DIRECTION  : DROITE 20" << std::endl;
            post(290);//dir = 1;

        }
        if(DIR != "DROITE 30" &&  YA < YB && std::abs(YB-YA) > 10 && std::abs(YB-YA) < 13  && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE 30";
            std::cout <<"DIRECTION  : DROITE 30" << std::endl;
            post(300);//dir = 1;

        }
        if(DIR != "DROITE 50" &&  YA < YB && std::abs(YB-YA) > 13 && std::abs(YB-YA) < 18  && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE 50";
            std::cout <<"DIRECTION  : DROITE 50" << std::endl;
            post(320);//dir = 1;

        }
        if(DIR != "DROITE 70" &&  YA < YB && std::abs(YB-YA) > 18 && std::abs(YB-YA) < 23 && OLDDIRECTION == DIRECTION )
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE 70";
            std::cout <<"DIRECTION  : DROITE 70" << std::endl;
            post(340);//dir = 1;

        }

        if(DIR != "DROITE 90" &&  YA < YB && std::abs(YB-YA) > 23  && OLDDIRECTION == DIRECTION )
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE 90";
            std::cout <<"DIRECTION  : DROITE 90" << std::endl;
            post(0);//dir = 1;
        ...
        if(DIR != "DROITE -20" &&  YA < YB && std::abs(YB-YA) > 5 && std::abs(YB-YA) < 10  && OLDDIRECTION == DIRECTION && XB-XA < 0)
        {
         ...
         if(DIR != "DROITE -30" &&  YA < YB && std::abs(YB-YA) > 10 && std::abs(YB-YA) < 15  && OLDDIRECTION == DIRECTION && XB-XA < 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
        ...
        if(DIR != "DROITE -50" &&  YA < YB && std::abs(YB-YA) > 15 && std::abs(YB-YA) < 22  && OLDDIRECTION == DIRECTION && XB-XA < 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
        ...
        if(DIR != "DROITE -80" &&  YA < YB && std::abs(YB-YA) > 22 && std::abs(YB-YA) < 25  && OLDDIRECTION == DIRECTION && XB-XA < 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "DROITE -80";
            std::cout <<"DIRECTION  : DROITE -80" << std::endl;
            post(115);//dir = 1;

        }
        if(DIR != "GAUCHE 25" && YA > YB && std::abs(YB-YA) > 5 && std::abs(YB-YA) < 13 && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "GAUCHE 25";
            std::cout <<"DIRECTION  : GAUCHE 25" << std::endl;
            post(245);//dir = 2;
        }

        if(DIR != "GAUCHE 50" && YA > YB && std::abs(YB-YA) > 13 && std::abs(YB-YA) < 20 && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "GAUCHE 50";
            std::cout <<"DIRECTION  : GAUCHE 50" << std::endl;
            post(220);//dir = 2;
        }
        if(DIR != "GAUCHE 80" && YA > YB && std::abs(YB-YA) > 20 && std::abs(YB-YA) < 25 && OLDDIRECTION == DIRECTION && XB-XA > 0)
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "GAUCHE 80";
            std::cout <<"DIRECTION  : GAUCHE 80" << std::endl;
           post(205);//dir = 2;
        }
        if(DIR != "GAUCHE 90" && YA > YB && std::abs(YB-YA) > 25  && OLDDIRECTION == DIRECTION )
        {
            std::cout <<"XA : "<< XA << std::endl;
            std::cout <<"XB : "<< XB << std::endl;
            std::cout <<"YA : "<< YA << std::endl;
            std::cout <<"YB : "<< YB << std::endl;
            DIR = "GAUCHE 90";
            std::cout <<"DIRECTION  : GAUCHE 90" << std::endl;
            post(180);//dir = 2;
        }
