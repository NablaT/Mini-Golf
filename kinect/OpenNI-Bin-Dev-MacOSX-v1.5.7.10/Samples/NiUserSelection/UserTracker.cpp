...
XnStatus UserTracker::GetLimbs(XnUserID nUserID, XnPoint3D *pLimbs,XnFloat *pConfidence, XnUInt16 &numLimbs)
{
    ...
    //std::cout<< "RIGHT_SHOULDER : " <<XN_SKEL_RIGHT_SHOULDER<<std::endl;

    //std::cout<<"LEFT_SHOULDER : "<<XN_SKEL_LEFT_SHOULDER<<std::endl;
    ...
    for(XnUInt16 i=0; i<MaxNumLimbs; i++)
    {
        ...
        limbCount++;
        //std::cout<< "RIGHT_SHOULDER : " << pLimbs[limbCount*2] <<std::endl;
        //std::cout<<"LEFT_SHOULDER : "<< joint2.position <<std::endl;
    }
